...
<body class="bg-black">
   ...
   <?php include 'data_queries/renew_users_display.php'; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Renewal Membership</h1>
                ...
                <div class="modal-body">
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        ...
                        <input type="text" name="users_account_id" class="form-control" placeholder="Enter account ID">


                        <!-- Membership and Type User -->
                        <div class="membership mt-3 d-flex justify-content-between mb-3">
                            <div>
                                <label for="">Type of membership</label>
                                <div class="gender mx-1 fs-6 fw-light mt-1">
                                    <label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="renew_btn">Renew</button>
                    </form>
                </div>
