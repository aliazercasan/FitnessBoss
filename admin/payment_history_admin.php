    ...
    <div class="container-fluid tw-min-h-screen tw-flex tw-flex-col mt-5">
        ...
        <div class="row tw-mx-auto tw-max-w-7xl tw-w-full">
            ...
            <div class="tw-w-full tw-mb-4 tw-flex tw-justify-center">
                <input type="text" id="searchBar" class="form-control tw-w-full md:tw-w-1/2 tw-p-2 tw-border tw-border-gray-300 tw-rounded-lg" placeholder="Search by Receipt ID, Account ID, or Name">
            </div>
