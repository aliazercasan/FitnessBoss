...
include 'data_queries/walk_in_sales_query.php';
...
<body class="bg-black lg:tw-p-5 md:tw-p-3 tw-p-0 tw-min-h-screen tw-overflow-hidden">
    <div class="container-fluid tw-min-h-screen tw-flex tw-flex-col">
        ...
        <div class="d-flex align-items-center justify-content-start tw-mt-20">
            ...
            <h1 class="tw-text-3xl tw-font-bold tw-text-white tw-mb-3 ms-1">Walk In Report</h1>
        </div>
                ...
                <div class="table-responsive">
                    <div class="tw-overflow-x-auto tw-max-h-96 tw-scrollbar-thin tw-scrollbar-thumb-gray-400 tw-scrollbar-track-gray-200">
                        <table class="table table-dark tw-w-full" id="dataTable">
                            <thead>
                                <tr>
                                    <th scope="col" class="tw-w-1/12">Walk-in ID</th>
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()) { ?>
                                    <tr>
                                        <td class="tw-text-blue-500 tw-text-center">
                                            <?php echo htmlspecialchars($row['walk_in_id']); ?>
                                        </td>
                                        <td class="tw-text-blue-500">
                                        ...
                                        <td class="tw-text-green-500 tw-text-right">
                    ...
                    <div class="tw-bg-white tw-text-black tw-py-2 tw-px-4 tw-rounded">
                        <h1 class="">Total SALES: ₱<?php include 'data_queries/total_sales.php';
                                                    echo htmlspecialchars($total_walkin); ?></h1>
                    </div>
                </div>
            </div>
        </div>
