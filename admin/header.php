  ...
  <div class="container">
    ...
    <div class="dropdown ms-2 md:tw-hidden tw-hidden lg:tw-block">
      ...
      <ul class="dropdown-menu tw-bg-black">
        <li><a class="dropdown-item hover:tw-bg-[#EA3EF7] tw-text-white tw-transition-ease-in-out tw-duration-200" href="profile_admin.php">Profile</a></li>
        <li><a class="dropdown-item hover:tw-bg-[#EA3EF7] tw-text-white tw-transition-ease-in-out tw-duration-200" href="renew_user_membership.php">Renew Membership</a></li>
