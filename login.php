...
<body>
    <?php include 'data_queries/login_query.php' ?>
        ...
        <div class="login-box d-flex flex-column flex-md-row align-items-center justify-content-between tw-w-full md:tw-w-3/4 lg:tw-w-1/2 tw-px-5 tw-py-3 tw-rounded-lg tw-shadow-lg bg-white">
            ...
            <div class="form-box tw-w-full md:tw-w-1/2 tw-flex tw-items-center tw-justify-center">
                <div class="tw-w-full tw-max-w-md">
                    <h1 class="tw-text-2xl md:tw-text-4xl tw-text-center fw-bold tw-text-[#EA3EF7] mb-3 mt-3">
                        LOG IN
                    </h1>
                    <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" class="tw-px-5 tw-py-3">

                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="username_email" required>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <p class="error_message tw-text-sm tw-text-red-500" ><?php echo $error_mess ?></p>
                        </div>

                        <div class="forgot text-end mb-3">
                            <a href="forgotpassword.php" class="nav-link tw-text-cyan-600 hover:tw-text-cyan-500 fw-semibold tw-text-sm">Forgot Password</a>
                        </div>
                        <button type="submit" class="tw-bg-[#00e69d] hover:tw-bg-[#00FFAE] tw-duration-100 tw-transition-ease-in fw-bold tw-w-full tw-py-3 tw-rounded-lg" name="btn-signin">
                            Sign In
                        </button>
